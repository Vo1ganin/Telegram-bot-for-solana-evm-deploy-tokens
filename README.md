...
## Чем README для HR отличается

Обычный технический README:
- больше деталей по настройке и отладке;
- рассчитан на разработчика.

README для HR/резюме:
- коротко описывает задачу, стек и результат;
- показывает, что проект рабочий и с понятной ценностью.

В этом репозитории можно держать техническую версию, а в верхней части сделать короткий блок для HR (как ниже).
